...
@DisplayName("Тест класса RegistrationService")
class RegistrationServiceTest {
    ...
    @InjectMocks
    RegistrationServiceImp registrationService;
    ...
    void findByIdNegativeTest() {
        ...
        assertThrows(EntityNotFoundException.class, () -> registrationService.findById(2L));
    ...
    public void findAllByIdPositiveTest() {
        ...
        List<RegistrationEntity> entityList = List.of(ENTITY);
        List<RegistrationDto> dtoList = List.of(DTO);

        when(repository.findAllById(ids)).thenReturn(entityList);
        when(mapper.toDtoList(entityList)).thenReturn(dtoList);

        List<RegistrationDto> result = registrationService.findAllById(ids);
    ...
    public void findAllByIdNegativeTest() {
        ...
        assertThrows(NullPointerException.class, () ->
                registrationService.update(ENTITY.getId(), DTO));
    }
    ...
    void savePositiveTest() {
        ...
        RegistrationDto result = registrationService.save(DTO);
    ...
    void saveNegativeTest() {
        ...
        RuntimeException exception = assertThrows(RuntimeException.class, () -> registrationService.save(DTO));

        assertEquals("Ошибка сохранения данных", exception.getMessage());
    }

    @Test
    @DisplayName("обновление существующего пользователя, позитивный тест")
    public void updatePositiveTest() {
        ...
        RegistrationDto result = registrationService.update(ENTITY.getId(), DTO);
    ...
    @Test
    @DisplayName("обновление несуществующего пользователя, негативный тест")
